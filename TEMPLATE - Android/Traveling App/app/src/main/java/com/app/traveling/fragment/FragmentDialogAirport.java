...
import com.app.traveling.adapter.AirportListAdapter;
...
public class FragmentDialogAirport extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        root_view = inflater.inflate(R.layout.fragment_dialog_airport, container, false);
        initToolbar();
        initComponent();
        return root_view;
    }
    ...
    private void initComponent() {
        ...
        final AirportListAdapter mAdapter = new AirportListAdapter(getActivity(), GlobalVariable.getInstance().getAirports());
