...
| [**MyLibSimpleSQLite**](https://github.com/gzeinnumer/MyLibSimpleSQLite)             | Simple way to CRUD `SQLite`                                    | [**AndroidFormValidation**](https://github.com/gzeinnumer/AndroidFormValidation)                         | Simple way to Validate `Form`                                    |
...
| [**NFCReader**](https://github.com/gzeinnumer/NFCReader)                             | Simple `NFC` Reader                                            | [**MyLibSavedInstanceState**](https://github.com/gzeinnumer/MyLibSavedInstanceState)                 | Simple `SavedInstanceState` with `StateUI`                       |
